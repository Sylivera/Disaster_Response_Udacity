...
def clean_data(df):
    ...
    #transform the columns to binary
    for column in categories.columns:
        categories[column] = categories[column].str.split('-').str[1]  # Extract the numeric part
        categories[column] = pd.to_numeric(categories[column], errors='coerce')  # Convert to numeric, invalid parsing will be set as NaN
